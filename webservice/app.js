...
app.get("/api/version", (req, res) => {
  res.send(JSON.stringify("Version_20180618_by_uilton"));
});
...
app.get("/api/listOSByCustomer", (req, res) => {
  var providerId = req.query.providerId;
  var customerId = req.query.customerId;
  connection.listOSByCustomer(providerId, customerId, function(
    err,
    rows,
    fields
  ) {
    console.log("Lista de OSs do cliente Carregada.", "ok");
    res.send(JSON.stringify(rows));
  });
});
